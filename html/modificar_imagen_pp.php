<?php
    ...
    else if($_GET['idU']!="")
    {
        ...
        if(!empty($_FILES['imagen']['tmp_name']))
        {
            ...
            $imagen = GetImagen($_GET['idU']);

            $qry = "update imagenes_pp set 
                    imagen='".$contenido."',
                    tipo='".$tipo."',
                    nombre='".$nombre."'
...
<html>
    ...
    <body>
        <div class="registro">
            ...
            ?>    
             - Modificar mi Imagen de Perfil </h1>
            
            <?php 
                echo "<form method='post' action='modificar_imagen_pp.php?idU=".$_GET['idU']."'
            ...
            ?>
                ...
                <?php
                    echo "<a href='perfil.php?idU=".$_GET['idU']."'>";
                ?>

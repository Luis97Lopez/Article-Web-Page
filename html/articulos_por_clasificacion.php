...
<html>
    ...
    <body class="cuerpo">
        ...
        <div class="layout">
            <span class="texto_busqueda"> Artículos del Género: 
                <a class="usuario"> <?php 
                    $clasificacion = GetClasificacion($_GET['idC']);
            ...
            $conn = ConectarBD();
                $qry = "select idArticulo, titulo, fecha, aprobado, texto, idClasificacion, idUsuario from articulos
                        where aprobado=1 and idClasificacion=".$_GET['idC']. " order by fecha desc";
            ...
            ?>         
                        <div class="articulo_busqueda">
                            ...
                            <div class="busqueda_info">
                                ...
                                <div class="info_apartado"> 
                                    <?php
                                    if(!empty($_SESSION) &&  $_SESSION['idUsuario'] == $registro['idUsuario'])
                                    {
                                        echo "  <a href='modificar_articulo.php?idA=".$registro['idArticulo']."' class='boton'> 
                                            <i class='fas fa-edit'></i> Editar  </a>
                                            <a href='../php/eliminar_articulo.php?idA=".$registro['idArticulo']."' class='boton'> 
                                            <i class='far fa-trash-alt'></i> Eliminar </a>";
                                        
                                        /*
                                        if($registro['aprobado'] == 0)
                                        {
                                            echo "<div class='boton'> <i class='fas fa-eye-slash'></i> En Espera </div>";
                                        }
                                        */
                                    }
                                    ?>
